...
python runner.py --json metadata/MC_"$arg1"_"$arg2"_BTV_Run3_"$arg2"_Comm_MINIAODv4_NanoV12.json --workflow ttdilep_sf --campaign $arg1 --year $arg2 --executor $arg3  -s 300
python runner.py --json metadata/data_"$arg1"_"$arg2"_em_BTV_Run3_"$arg2"_Comm_MINIAODv4_NanoV12.json --workflow ttdilep_sf --campaign $arg1 --year $arg2 --executor $arg3 -s 300
